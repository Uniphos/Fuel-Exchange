...
const SignUp = () => {
    ...
    const handleButtonClick = (page) => {
        if (page === 'buyer') {
            window.location.href = '/Fuel-Exchange/#/ProfileSignUp/buyer/';
        } else if (page === 'seller') {
            window.location.href = '/Fuel-Exchange/#/ProfileSignUp/seller/';
        }
    }
    ...
    return (
        ...
        <div className='signUp'>
            ...
            <p>Already have an account? <a href='/Fuel-Exchange/#/login' className='change'>Sign In</a></p>
        </div>
        </div>
    );
};
